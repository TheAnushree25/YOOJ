 ...
 *
 * The technical trail - which pages of the deck were read, and by whom. The
 * admin's own record of visits and sign-ups is the Google Forms' sheets, sent
 * from the page itself (src/lib/google-forms.ts); this lives only as long as
